/*                                                                              
           SAS DATA DEFINITION STATEMENTS FOR ICPSR 7757                        
   ...
   number of characters allowed for each value label.NOTE:  Some value          
   labels are entered as comments "/*".  An office code "7" appears in the      
   file beginning with 1968 elections for V8.  If V8 does equal 7 then in       
   V9, accompanying the office code of "7", will be a state office code.        
   ...
   LABELS assigns variable labels for all variables in the data file.           
                                                                                
   FORMAT associates the SAS formats defined by the PROC FORMAT step            
   ...
   Note:  This are designated as comments.                                      
...
;                                                                               
VALUE V9f                                                                       
/* An office code "7" appears in the file beginning with 1968                   
    elections.  If variable 8, is coded "7", accompanying it                    
    in variable 9 will be state office code.                                    
       001="001: Sec. of State"                                                 
       002="002: Att. General"                                                  
       003="003: State Auditor"                                                 
       004="004: State Treas."                                                  
       005="005: Auditor Pub. Accounts."                                        
       006="006: Pub. Serv. Comm."                                              
       007="007: Comptroller "                                                  
       008="008: Lt. Governor "                                                 
       009="009: Comm. of Labor "                                               
       010="010: Tax Commissioner"                                              
       011="011: Corp. Comm." */                                                
       999="999: MISSING DATA"                                                  
;                                                                               
VALUE $V10f                                                                     
       G="G: General"                                                           
       S="S: Special"                                                           
...
VALUE V13f                                                                      
 ...
 ;                                                                              
VALUE V15f                                                                      
       000="000: Inappropriate"                                                 
       999="999: MISSING DATA"                                                  
;                                                                               
VALUE V16f                                                                      
       -000009="-000009: MISSING DATA"                                          
;                                                                               
VALUE V17f                                                                      
       99="99: MISSING DATA"                                                    
;                                                                               
VALUE V18f                                                                      
       999.9="999.9: MISSING DATA"                                              
;                                                                               
VALUE  V19f                                                                     
       000.0="000.0: Zero percent"                                              
       999.9="999.9: MISSING DATA"                                              
;                                                                               
VALUE  V20f                                                                     
       999.9="999.9: MISSING DATA"                                              
...
;                                                                               
VALUE  V23f                                                                     
       0="0: Candidate DID NOT win"                                             
       1="1: Candidate DID win"                                                 
       9="9: MISSING DATA"                                                      
;                                                                               
DATA;                                                                           
INFILE 'da7757.5ed' LRECL=113;                                                  
INPUT                                                                           
  V1 1-4                                                                        
  V2 5-5                                                                        
  V3 6-6                                                                        
...
LABEL                                                                           
  ...
  V2="ICPSR VERSION NUMBER"                                                     
  V3="ICPSR PART NUMBER"                                                        
  V4="ASTERISK CNL-ONLY DATA"                                                   
  V5="CAND NUMBER"                                                              
  V6="ICPSR STATE CODE"                                                         
  V7="YEAR OF ELECTION"                                                         
  V8="OFFICE CODE"                                                              
  V9="CONGRESSIONAL DIST NO"                                                    
  V10="ELECTION TYPE CODE"                                                      
  V11="MONTH OF ELECTION"                                                       
  V12="CANDIDATE'S VOTE"                                                        
  V13="ICPSR PARTY CODE"                                                        
  V14="CANDIDATE'S NAME"                                                        
  V15="CONGRESS TO WHICH ELECTD"                                                
  V16="TOTAL VOTE CAST IN ELEC"                                                 
  V17="NUMBER OF CANDIDATES"                                                    
  V18="HIGHEST PERCENT"                                                         
  V19="2ND HIGHEST PERCENT"                                                     
  V20="MARGIN OF VICTORY"                                                       
  V21="CANDIDATE'S PERCENT"                                                     
  V22="CANDIDATE'S % FRM VICTOR"                                                
  V23="ELECTION OUTCOME"                                                        
  ;                                                                             
FORMAT                                                                          
    V5    V5f.                                                                  
    V6    V6f.                                                                  
...
/*                                                                              
 ...
 IF V9=999 THEN V9=.;                                                           
 IF V11=99 THEN V11=.;                                                          
 IF V12=-00000009 THEN V12=.;                                                   
 IF V13=9999 THEN V13=.;                                                        
 IF V15=999 THEN V15=.;                                                         
 IF V16=-00000009 THEN V16=.;                                                   
 IF V17=99 THEN V17=.;                                                          
 IF V18=9999 THEN V18=.;                                                        
 IF V19=9999 THEN V19=.;                                                        
 IF V20=9999 THEN V20=.;                                                        
 IF V21=9999 THEN V21=.;                                                        
 IF V22=9999 THEN V22=.;                                                        
 IF V23=9 THEN V23=.;                                                           
 */                                                                             
